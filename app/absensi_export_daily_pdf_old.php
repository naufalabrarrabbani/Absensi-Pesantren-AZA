...
if ($selected_class) {
    ...
    $filename .= '_' . ($kelas_info ? $kelas_info['nama_kelas'] : $selected_class);
}
$filename .= '.pdf';
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;"><?= htmlspecialchars($data['nik']); ?></td>
                <td><?= htmlspecialchars($data['nama']); ?></td>
                <td style="text-align: center;"><?= htmlspecialchars($data['kelas']); ?></td>
